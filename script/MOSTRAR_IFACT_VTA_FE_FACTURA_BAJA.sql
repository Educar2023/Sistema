ALTER PROCEDURE [dbo].[MOSTRAR_IFACT_VTA_FE_FACTURA_BAJA]            
AS            
SELECT            
...
AND ISNULL(A.STATUS_ANUL,'0')= '1'          
AND ISNULL(A.STATUS_BAJA_FE,'0')= '0'            
AND A.COD_DOC IN ('01','07','08')        
AND (A.COD_REF IS NULL OR A.COD_REF IN ('01') OR A.COD_REF = '')        
